...
<html>
	...
	<script type="text/javascript">
		function checkPassword(){
			...
			var fm = document.updateUserform;
  			fm.action="userAction_updateUser.action";
  			fm.submit();
  ...
  <body>
   <s:form name="updateUserform" data-dojo-type="dijit.form.Form" action="userAction_updateUser.action" method="post" theme="simple">
    	<br>
    	<table>
						...
						<tr>	
								...
								<button type="button" name="back" onclick="javascript:window.location.href='index.jsp'">撤销修改</button> 
								<button type="button" name="cancel" onclick="javascript:window.location.href='index.jsp'">取消</button> 
								</td>
						</tr>	
						</table>
