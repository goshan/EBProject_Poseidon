...
import com.ibm.p1.tools.MD5Util;
import com.ibm.p1.tools.Mail;
import com.ibm.p1.tools.OAuth4Code;
...
public class UserAction {
	...
	public String login() throws IOException, WeiboException{
		...
		if(userInfo == null)
		{
			...
			if("mobile".equals(request_type)){
				...
				String code = userInfo.getUser_id()+userInfo.getPassword()+date.getTime();
				String access_token = MD5Util.MD5(code);
				if(access_token == null || ("").equals(access_token)){
					flag ="false_to_create_access_token";
					json.put("flag", flag);
					pw.write(json.toString());
					pw.flush();
					pw.close();
					return "false_to_create_access_token";
				}
