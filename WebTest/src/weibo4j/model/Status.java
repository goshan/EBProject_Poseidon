...
public class Status extends WeiboResponse implements java.io.Serializable {
	...
	*/
	...
	public String toString() {
		...
		return "{user=" + (user == null ?"":user) +", createdAt=\""
				+ createdAt + "\""+", id=\"" + id + "\""+", text=\"" + content + "\""+", source="
				+ (source==null ?"":source) +", inReplyToStatusId=\"" + inReplyToStatusId
				+ "\""+", inReplyToUserId=\"" + inReplyToUserId
				+ "\""+", inReplyToScreenName=\"" + inReplyToScreenName
				+ "\""+", retweetedStatus=" + (retweetedStatus == null ? "":retweetedStatus) +", latitude=\"" + latitude +"\""+ ", longitude=\"" + longitude
				+ "\""+", repostsCount=\"" + repostsCount +"\""+ ", commentsCount=\""
